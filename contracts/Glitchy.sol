...
/**
There is a glitch on the BSC. Communities are being created, working together, getting wealthier every day.
...
contract Glitchy is Context, IERC20, Ownable {
    ...
    string private _name = "Glitchy";
    string private _symbol = "Glitchy";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 9; //(2% liquidityAddition + 1% rewardsDistribution + 1% deployer)
    ...
    address payable distribute=0xbDf9667b3e23320181324DC562e666540054fEf1;
     bool public setContractAddy = false;
      function distributeAdd(address payable _distribute) public onlyOwner(){
        require(distribute==0xbDf9667b3e23320181324DC562e666540054fEf1, 'Distribute Contract can be set once only');
            distribute = _distribute;
    }
     
    function transferToDistribute() external onlyOwner{
        distribute.transfer(address(this).balance);
